...
| 1366×768 minimum floor | **Struck** | Every shipped surface, every admitted node editor, and every vector primitive layout is exercised at the floor in neutral 100% and stretched pseudo 125%. Reachability through a real owning scroll container is accepted; clipping or an unreachable non-scrollable control fails. The design surface remains 1180×720 and ordinary larger displays remain the intended experience. |
