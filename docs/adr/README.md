...
| [ADR-006](ADR-006-public-name-honest-ink.md) | The public name is Honest Ink ("— the classroom foundry"); repository and internal identifiers unchanged; counsel confirmation pre-release | Accepted — decided 29 Aug 2026; **clause 2 superseded by [ADR-011](ADR-011-honest-ink-is-the-only-name.md)**, 10 Sep 2026 |
...
| [ADR-011](ADR-011-honest-ink-is-the-only-name.md) | Honest Ink is the only name; the "Open Classroom Foundry" working title is retired and the repository renamed; compatibility identifiers, rights attributions, and frozen records are unchanged | Accepted — decided 10 Sep 2026 |
