...
| Documentation, contribution, localization workflows | **Done / human catalog pending** | README, GOVERNANCE, CONTRIBUTING, council charter, data inventory, and Gate C design exist. The deterministic 979-string catalog workflow is fail-closed; no second language is claimed until the multilingual seat reviews an actual catalog and its exact bytes are pinned |
