...
| [handover/2026-08-30-the-public-turn.md](handover/2026-08-30-the-public-turn.md) | The public turn — **the current state of the repository**: the move to the organization, going public, the live site, the seeded-error study rebuilt as an input, the machine guardrails and the agent wiring, and the lesson the session paid for four times |
