...
The current neutral inventory measured **1,072 ids**. Two independent exports for the current source tree were byte-identical at **163,309 bytes**: packet SHA-256 `F4FFB140E8DB460C567877AD97733C1EA60EB05A1545F6FC82A1CBDB1F9ED39E`, bound to source digest `5cc0216be58608ecfcb6367524b85615be4ee6b0e0dbe64ea41b1364ea201784`. The focused catalog contract passed **26/26**. Those values identify the deterministic neutral review packet only. They are not a protected-seat review record, a second-language catalog, or a production activation pin; the current allowlist remains empty.
