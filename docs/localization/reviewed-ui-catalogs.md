...
The final neutral inventory measured **996 ids**. Two independent exports for the current source tree were byte-identical: packet SHA-256 `2C803158A5BDCA3B71EA77E893DCCFF3F8F2D646859C4A3524961FFAE15997DE`, bound to source digest `c9bb2685b57824a3feec14eb79cd51038d4a1f64632e1f9538df9d954e193b0a`. Those values identify the deterministic neutral review packet only. They are not a protected-seat review record, a second-language catalog, or a production activation pin; the current allowlist remains empty.
