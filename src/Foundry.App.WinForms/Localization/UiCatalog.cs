...
internal static class UiCatalogAccessKeyContexts
{
    ...
    [
        ...
        Context("built-in-studios",
            nameof(UiStrings.ImportAndVerifyBoard),
            ...
            nameof(UiStrings.CancelExport),
            nameof(UiStrings.SaveToLibrary)),
        Context("board-to-brief-intake",
            nameof(UiStrings.BoardIntakeNextUncertain),
            nameof(UiStrings.BoardIntakeAcceptCandidate),
            nameof(UiStrings.BoardIntakeRetype),
            nameof(UiStrings.BoardIntakeMarkIllegible),
            nameof(UiStrings.BoardIntakeUseManual),
            nameof(UiStrings.BoardIntakeMoveLineUp),
            nameof(UiStrings.BoardIntakeMoveLineDown),
            nameof(UiStrings.BoardIntakeFinish),
            nameof(UiStrings.BoardIntakeCancel),
            nameof(UiStrings.SafetyPause)),
        Context("board-to-brief-intake-purge-retry",
            nameof(UiStrings.RetrySecurePurge)),
        ...
        Context("capture",
            ...
            nameof(UiStrings.CropLeftX),
            nameof(UiStrings.CropTopY),
            nameof(UiStrings.CropWidth),
            nameof(UiStrings.CropHeight),
            nameof(UiStrings.ApplyCrop),
            nameof(UiStrings.ResetCrop),
            nameof(UiStrings.LaneGreen),
            nameof(UiStrings.LaneAmber),
            nameof(UiStrings.ConfirmLane),
            nameof(UiStrings.SafetyPause)),
        Context("capture-retry",
            nameof(UiStrings.RetryNormalization),
            nameof(UiStrings.Rotate90),
            nameof(UiStrings.CropLeftX),
            nameof(UiStrings.CropTopY),
            nameof(UiStrings.CropWidth),
