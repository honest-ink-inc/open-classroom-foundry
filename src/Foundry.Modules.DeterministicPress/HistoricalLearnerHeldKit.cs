...
// Exact C1 producer/transform retained for explicitly historical routes.
// Do not repair these semantics in place; use the selected replacement definition.
public static class HistoricalLearnerHeldKit
{
